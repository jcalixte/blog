...
When I'm talking with tech leaders, my goal is to sharpen their vision about the software we are working on. When developers implement features, I often see responsability leaks: the feature works, but components are hard to read, hard to reuse and we pile up technical debt really quickly.
